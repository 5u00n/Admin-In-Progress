...
const Syllabus = () => {
    ...
    if (subjectOptionGroup.length === 0) {
        subjectOptionGroup = [
            {
                label: "Subjects ...",
                options: [
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <Breadcrumbs title="Edusofthub" breadcrumbItem="Acadamics" breadcrumbSubItem="Syllabus" />
            ...
            <Modal isOpen={modal_list} toggle={() => { tog_list(); }} centered >
                <ModalHeader className="bg-light p-3" id="exampleModalLabel" toggle={() => { tog_list(); }}> Add Syllabus </ModalHeader>
                <form className="tablelist-form">
                    <ModalBody>
                        ...
                        <div className="mb-3">
                            <label htmlFor="customername-field" className="form-label">Syllabus Name</label>
                        ...
                        <div className="mb-3">
                            <label htmlFor="email-field" className="form-label">Select Section</label>
                            <Select
                        ...
                        <div className="mb-3">
                            <label htmlFor="email-field" className="form-label">Select Subject </label>
                            <Select
                        ...
                        <div className="mb-3">
                            <label htmlFor="phone-field" className="form-label">Add PDF File</label>
                            <input type="file" id="file-field" className="form-control"  required />
                        </div>
                    ...
                    <ModalFooter>
                        <div className="hstack gap-2 justify-content-end">
                            ...
                            <button type="submit" className="btn btn-success" id="add-btn">Add Syllabus</button>
            ...
            <Modal isOpen={modal_list_bulk} toggle={() => { tog_list_bulk(); }} centered >
                <ModalHeader className="bg-light p-3" id="exampleModalLabel" toggle={() => { tog_list_bulk(); }}> Add Syllabus In Bulk</ModalHeader>
                <form className="tablelist-form">
                    <ModalBody>
                        <div className="mb-3" >
