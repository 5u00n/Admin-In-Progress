    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <Breadcrumbs title="Edusofthub" breadcrumbItem="Acadamics" breadcrumbSubItem="Deparment" />
            ...
            <Modal isOpen={modal_list} toggle={() => { tog_list(); }} centered >
                <ModalHeader className="bg-light p-3" id="exampleModalLabel" toggle={() => { tog_list(); }}> Add Deparment </ModalHeader>
                <form className="tablelist-form">
                    <ModalBody>
                        ...
                        <div className="mb-3">
                            <label htmlFor="customername-field" className="form-label">Deparment Name</label>
                            <input type="text" id="customername-field" className="form-control" placeholder="Enter Name" required />
                        </div>
                        {/*
                        <div className="mb-3">
                            <label htmlFor="email-field" className="form-label">Set Number of Sections</label>
                            <input type="text" id="num-field" className="form-control" placeholder="Enter number of sections ..." required />
                        </div>
                        {/*
                        <div className="mb-3">
                    ...
                    <ModalFooter>
                        <div className="hstack gap-2 justify-content-end">
                            ...
                            <button type="submit" className="btn btn-success" id="add-btn">Add Deparment</button>
            ...
            <Modal isOpen={modal_list_bulk} toggle={() => { tog_list_bulk(); }} centered >
                <ModalHeader className="bg-light p-3" id="exampleModalLabel" toggle={() => { tog_list_bulk(); }}> Add Deparment In Bulk</ModalHeader>
                <form className="tablelist-form">
                    <ModalBody>
                        <div className="mb-3" >
