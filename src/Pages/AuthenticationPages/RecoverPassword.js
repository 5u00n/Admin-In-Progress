...
const RecoverPassword = () => {
    document.title = "Recover Password | Edusofthub - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                        ...
                        <Row className="justify-content-center">
                            <Col lg={6} md={8} xl={4}>
                                <Card className='mt-5'>
                                    <CardBody className="p-4">
                                        <div className="">
                                            ...
                                            <p className="mb-5 text-center">Reset your Password with Edusofthub.</p>
                                ...
                                <div className="mt-5 text-center">
                                    ...
                                    <p className="text-white-50">© {new Date().getFullYear()} Edusofthub. Crafted with <i className="mdi mdi-heart text-danger"></i> by DevEdits</p>
                                </div>
                            </Col>
                        </Row>
                    </Container>
