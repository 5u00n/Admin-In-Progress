    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <Breadcrumbs title="Edusofthub" breadcrumbItem="Users" breadcrumbSubItem="Admin" />
            ...
            <Modal isOpen={modal_list} toggle={() => { tog_list(); }} centered >
                <ModalHeader className="bg-light p-3" id="exampleModalLabel" toggle={() => { tog_list(); }}> Add Admin </ModalHeader>
                <form className="tablelist-form">
                    ...
                    <ModalFooter>
                        <div className="hstack gap-2 justify-content-end">
                            ...
                            <button type="submit" className="btn btn-success" id="add-btn">Add Admin</button>
            ...
            <Modal isOpen={modal_list_bulk} toggle={() => { tog_list_bulk(); }} centered >
                <ModalHeader className="bg-light p-3" id="exampleModalLabel" toggle={() => { tog_list_bulk(); }}> Add Admin In Bulk</ModalHeader>
                <form className="tablelist-form">
                    <ModalBody>
                        <div className="mb-3" >
